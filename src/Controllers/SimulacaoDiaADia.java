    ...
    public class SimulacaoDiaADia {
        ...
        private void exibirReservasNoMomento(int momento) {
            ...
            for (ClienteReserva reserva : reservas) {
                if (reserva != null && reserva.getHoraChegada() == momento) {
        ...
        private void criarPedido(Scanner scanner, int momentoAtual) {
            ...
            if (reserva.getMomentoAtribuicao() == momentoAtual) {
                System.out.println("Não é possível criar um pedido neste momento.");
                return;
            }
           ...
           int idPedido = pedidoAtual++;
            ...
            System.out.println("teste:" + tempoTotalPreparacao);

            Pedido novoPedido = new Pedido(idPedido, mesa, pratosSelecionados, momentoAtual, tempoTotalPreparacao, 1);
            mesa.setPedidoAssociado(novoPedido);
            pedidos[pedidoAtual] = novoPedido;
        ...
        private void finalizarPedido(Scanner scanner, int momentoAtual) {
            ...
            if (momentoAtual < pedido.getMomentoEntrega() + maiorTempoConsumo) {
